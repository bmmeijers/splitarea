#from cymesher.delaunay import Triangulation
#from cymesher.primitives import Vertex, Point
...
from simplegeo.geometry import LineString, Envelope, Point
...
#    from brep.io import geom_from_text
    from simplegeo.wkt import loads
...
#        # flag = 1: vertex where external edges are incident
#        # flag = 0: intermediate vertex
#        # we connect connectors when flag = 1
#        vtx = mesh.insert(vtx)
#        vtx.flag = flag 
...
#        vtx.vid = vid
#        if i == 0:
#            vtx.vid = vertex_ids[start_node]
#        elif i == len(geometry) - 1:
#            vtx.vid = vertex_ids[end_node]
#        if i > 0:
#            mesh.add_constraint(prev_vtx, vtx)

#    wkt_island = """POLYGON((1748250 5136550, 1748260 5136550, 1748260 5136560, 1748250 5136560, 1748250 5136550))
#    """
#    poly = loads(wkt_island)
#    #if DEBUG: print poly
#    ln = []
#    for ring in poly:
#        for vtx in ring:
#            ln.append(vtx)
#    for i, vtx in enumerate(ln):
#        vtx = Vertex(vtx.x, vtx.y)
#        if i == 2:
#            vtx.flag = 2
#            vtx.label = 503
#        else:
