...
def recs():
    ...
    # eid, geom, sn, sn_ext, svtxid, en, en_ext, evtxid, lf, rf,
     (252, 135, False, 135, 130, True, 130, 54, 45, LineString([Point(x=560850.10666, y=5897605.99348, srid=32632), Point(x=560741.10142, y=5897548.82285, srid=32632), Point(x=560721.14836, y=5897552.58643, srid=32632)], srid=32632))
    ,(253, 130, True, 130, 141, False, 141, 74, 45, LineString([Point(x=560721.14836, y=5897552.58643, srid=32632), Point(x=560722.71918, y=5897569.99831, srid=32632), Point(x=560693.83728, y=5897603.2688, srid=32632), Point(x=560756.86961, y=5897619.73413, srid=32632), Point(x=560777.04418, y=5897623.14318, srid=32632), Point(x=560797.7284, y=5897626.93212, srid=32632), Point(x=560848.93159, y=5897639.2497, srid=32632)], srid=32632))
    ,(275, 146, False, 146, 149, False, 149, 74, 51, LineString([Point(x=560852.35323, y=5897649.45567, srid=32632), Point(x=560817.76284, y=5897681.17662, srid=32632), Point(x=560795.42893, y=5897701.01108, srid=32632), Point(x=560832.65749, y=5897740.48761, srid=32632), Point(x=560836.92066, y=5897740.48056, srid=32632), Point(x=560861.8534, y=5897713.28732, srid=32632), Point(x=560861.9305, y=5897709.23867, srid=32632), Point(x=560894.51146, y=5897674.45864, srid=32632)], srid=32632))
    ,(290, 142, False, 142, 166, True, 166, 74, 54, LineString([Point(x=560923.98887, y=5897644.8424, srid=32632), Point(x=560924.54319, y=5897645.13689, srid=32632), Point(x=560951.61553, y=5897659.51281, srid=32632), Point(x=561160.70759, y=5897771.29099, srid=32632), Point(x=561206.42491, y=5897795.92407, srid=32632), Point(x=561218.48727, y=5897804.06678, srid=32632)], srid=32632))
    ]
    # polygon edges
    polygon = [
