...
from splitarea.flagging import EdgeEdgeHarvester, VertexInfo #, MidpointHarvester, VertexInfo
...
#    Triangle with hole
    ...
    conv.add_point(f, info = VertexInfo(2, "C", 1003))
    ...
    conv.add_segment(f, g)
    conv.add_segment(g, h)
    conv.add_segment(h, f)
